...
def config_network(p4):
    ...
    # Network definition
    net.addP4Switch('s1',cli_input= default_rule + 'nettrail-s1.txt')
    net.addP4Switch('s2',cli_input= default_rule + 'nettrail-s2.txt')
    net.addP4Switch('s3',cli_input= default_rule + 'nettrail-s3.txt')
    net.addP4Switch('s4',cli_input= default_rule + 'nettrail-s4.txt')
    net.addP4Switch('s5',cli_input= default_rule + 'nettrail-s5.txt')
    net.addP4Switch('s6',cli_input= default_rule + 'nettrail-s6.txt')
